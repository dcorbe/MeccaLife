...
sleep 0.1;
_var=floor(random 3);
if (_var==1) then {_box addWeaponCargoGlobal ["9Rnd_45ACP_Mag", 1];};
sleep 0.1;
_var=floor(random 3);
...
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["100Rnd_580x42_Mag_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_ARX_Viper_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["30Rnd_65x39_caseless_green", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_AKS_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["30Rnd_545x39_Mag_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_AKM_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["30Rnd_762x39_Mag_F", 1];};
sleep 0.1;
_var=floor(random 10);
...
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["10Rnd_9x21_Mag", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["LMG_03_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["200Rnd_556x45_Box_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["launch_RPG7_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["RPG7_F", 1];};
sleep 0.1;
_var=floor(random 10);
if (_var==1) then {_box addWeaponCargoGlobal ["RPG32_F", 1];};
sleep 0.1;
