...
if(typeOf _vault != "Land_Bunker_F") exitWith {hint localize "STR_ISTR_Blast_VaultOnly"};
...
if(!([false,"armblastingcharge",1] call life_fnc_handleInv)) exitWith {}; //Error?

_vault setVariable["chargeplaced",true,true];
[[0,localize "STR_ISTR_ABlast_Placed"],"life_fnc_broadcast",west,false] call life_fnc_MP;
[[_vault],"life_fnc_bankalarmsound",true,true] call life_fnc_MP;
hint localize "STR_ISTR_Blast_KeepOff";

[[15],"life_fnc_armdemoChargeTimer",west,false] call life_fnc_MP;
[[15],"life_fnc_armdemoChargeTimer",group player,false] call life_fnc_MP;
...
[["arm",15],"TON_fnc_blowSafe",false,false] spawn life_fnc_MP;