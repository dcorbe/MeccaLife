...
if((_curWep in ["srifle_DMR_06_olive_F","srifle_DMR_03_F","arifle_MXM_Black_F","arifle_MX_Black_F","arifle_MXC_Black_F","srifle_DMR_02_F","arifle_sdar_F","arifle_SPAR_03_blk_F","arifle_AK12_F"]) && (_source getVariable ["nonLethals",true]) && (_projectile != "")) then {
