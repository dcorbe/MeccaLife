...
if (life_pInact_curTarget getVariable ["blindfolded", false]) then {
	...
	_Btn10 buttonSetAction "if(player distance life_pInact_curTarget > 4) exitWith {hint 'You are too far away.'};[life_pInact_curTarget] call life_fnc_blindfoldaction;"
};
