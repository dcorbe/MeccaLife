...
if (life_pInact_curTarget getVariable ["blindfolded", false]) then {
	...
	_Btn10 buttonSetAction "if(player distance life_pInact_curTarget > 4) exitWith {hint 'You are too far away.'};[life_pInact_curTarget] call life_fnc_unblindfoldaction; closeDialog 0;"
} else {
	_Btn10 ctrlSetText localize "STR_pInAct_blindfold";
	_Btn10 buttonSetAction "if(player distance life_pInact_curTarget > 4) exitWith {hint 'You are too far away.'};[life_pInact_curTarget] call life_fnc_blindfoldaction; closeDialog 0;"
};
